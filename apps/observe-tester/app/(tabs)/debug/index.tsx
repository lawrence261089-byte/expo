...
import { PastDiagnosticPayloadsSection } from '@/components/PastDiagnosticPayloadsSection';
...
export default function Debug() {
  ...
  return (
    <ScrollView
      ...
      <PastDiagnosticPayloadsSection />
      {typeof AppMetrics.getPastDiagnosticPayloads === 'function' ? <Divider /> : null}
      <Button
